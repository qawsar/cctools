    ...
    $(document).ready(function() {
        ...
        for (var z = 0; z < b.length; z++) {
            if (b[z].innerHTML == "Contact information"){
                b[z].innerHTML = "Contact information <input type=\"submit\" name=\"cancel\" value=\"Cancel\" style=\"float: right;\"><div style=\"float: right;\">&nbsp;&nbsp;</div><input type=\"submit\" name=\"apply\" value=\"Apply\" class=\"green\" style=\"float: right;\"><div style=\"float: right;\">&nbsp;&nbsp;</div><input type=\"submit\" name=\"submit\" value=\"Save\" class=\"green\" style=\"float: right;\">";
            }
        }
